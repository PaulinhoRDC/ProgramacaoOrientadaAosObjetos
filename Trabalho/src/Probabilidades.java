...
/*
Esconder, em determinados contextos, Comportamentos associados a um determinado tipo de dados, neste caso as
probabilidades que serão utilizadas no contexto de simulação de um jogo (quer com print ou não)
 */
public interface Probabilidades {
    Random rand = new Random();

    default double probabilidadeMarcar(double frente){
        int r = 0;
    ...
    default double probabilidadeDefender(double defesa){
        int r = 0;
        if(defesa > 0){
    ...
    default double probabilidadeMeio(double medio){
        int r = 0;
        if(medio > 0){
    ...
    default double probabilidadeRedes(double redes){
        int r = 0;
        if(redes > 0){
    ...
    default double probabilidadeLateral(double lateral){
        int r = 0;
        if(lateral > 0){
